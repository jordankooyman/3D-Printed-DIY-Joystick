...
#define Output_delay 100 // How long to pause between read/update cycles
...
#define Pitch_max_deadzone 10350 // Set to the max value of the desired deadzone
#define Pitch_min_deadzone 9500 // Set to the min value of the desired deadzone
...
#define Roll_max_value 16000    // Set to the max value of Roll Axis
#define Roll_min_value 8300    // Set to the min value of Roll Axis
...
#define Roll_ADC 3              // Set to the adc pin number this axis is connected to (between 0 and 3 inclusive)
...
#define Yaw_min_value 8000    // Set to the min value of Yaw Axis
#define Yaw_max_deadzone 11800 // Set to the max value of the desired deadzone
#define Yaw_min_deadzone 10600 // Set to the min value of the desired deadzone
...
#define Throttle_max_value 24300    // Set to the max value of Throttle Axis
#define Throttle_min_value 300    // Set to the min value of Throttle Axis
#define Throttle_max_deadzone 12800 // Set to the max value of the desired deadzone
#define Throttle_min_deadzone 11700 // Set to the min value of the desired deadzone
#define Throttle_ADC 2              // Set to the adc pin number this axis is connected to (between 0 and 3 inclusive)
...
#ifndef Serial_Mode
Joystick_ Joystick(0x05,JOYSTICK_TYPE_JOYSTICK, //hid report ID, hid device type
...
*/
Serial.print("Axis output enable: "); Serial.println(out_enable);
...
#else
//set analog axes
if (out_enable == 1) { // If Button 12 (lowest grip button) is held, output the joystick data, otherwise set it to 0 as the output
