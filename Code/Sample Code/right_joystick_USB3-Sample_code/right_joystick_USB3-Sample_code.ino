...
#define deadzone_lower_Pitch 12900  //Set these to the lower and upper limits of Pitch wiggle on joystick before springs kick in
#define deadzone_upper_Pitch 13400  //Set to the same as the lower to disable
#define deadzone_Loffset_Pitch 100  //Determined through Trial/Error testing, the lower offset up to make the numbers below the deadzone range exactly end at 0
#define deadzone_Uoffset_Pitch 900//Determined through Trial/Error testing, the upper offset down to make the numbers below the deadzone range exactly end at 0
...
#define deadzone_Loffset_Roll 2500  //Determined through Trial/Error testing, the lower offset up to make the numbers below the deadzone range exactly end at 0
#define deadzone_Uoffset_Roll -1100 //Determined through Trial/Error testing, the upper offset down to make the numbers below the deadzone range exactly end at 0
...
#define deadzone_Loffset_Yaw 950  //Determined through Trial/Error testing, the lower offset up to make the numbers below the deadzone range exactly end at 0
#define deadzone_Uoffset_Yaw 500//Determined through Trial/Error testing, the upper offset down to make the numbers below the deadzone range exactly end at 0
...
if (adc0 < deadzone_lower_Yaw) {
  adc0 += deadzone_range_Yaw + deadzone_Loffset_Yaw;
}
else if (adc0 > deadzone_upper_Yaw) {
  adc0 -= deadzone_range_Yaw + deadzone_Uoffset_Yaw;
}
else {
...
if (adc1 < deadzone_lower_Pitch) {
  adc1 += deadzone_range_Pitch + deadzone_Loffset_Pitch;
}
else if (adc1 > deadzone_upper_Pitch) {
  adc1 -= deadzone_range_Pitch + deadzone_Uoffset_Pitch;
}
else {
...
if (adc3 < deadzone_lower_Throttle) {
  adc3 += deadzone_range_Throttle + deadzone_Loffset_Throttle;
}
else if (adc3 > deadzone_upper_Throttle) {
  adc3 -= deadzone_range_Throttle + deadzone_Uoffset_Throttle;
}
else {
...
if (adc2 < deadzone_lower_Roll) {
  adc2 += deadzone_range_Roll + deadzone_Loffset_Roll;
}
else if (adc2 > deadzone_upper_Roll) {
  adc2 -= deadzone_range_Roll + deadzone_Uoffset_Roll;
}
else {
